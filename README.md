...
🌐 **[poe2uai.0at.net](https://poe2uai.0at.net)** — українська база Path of Exile 2: камені вмінь, предмети, унікалки й валюта з українськими та англійськими назвами, характеристиками й цінами. Англійську назву можна скопіювати одним кліком для пошуку в трейді.
...
| | |
|---|---|
| Версія гри | **0.5.5c** (Steam build 25379396, оновлення від 18.09.2026), ліга Runes of Aldur |
| Версія перекладу | v1.6.7 (23.09.2026) |
...
**Потрібно:** Windows або SteamOS / Linux (Proton) і Path of Exile 2 у Steam. Усе інше вже є в архіві релізу — встановлювати нічого не треба.
...
**Якщо щось пішло не так:** інсталятор пише, що саме не так, українською (немає Node.js, немає oo2core, гра запущена, не знайдено гру). Якщо гра стоїть не в Steam-бібліотеці, задайте шлях: у командному рядку `set POE2_DIR=D:\Games\Path of Exile 2` і запустіть `INSTALL.bat` з того ж вікна.

### SteamOS / Steam Deck / Linux
Найпростіше — через LBK Launcher: він сам розпакує архів у теку гри й запустить `INSTALL.bat` через Proton. Вручну: розпакуйте архів LBK-версії в теку гри (`steamapps/common/Path of Exile 2`) і запустіть `poe2-ukrainian/INSTALL.bat` через Proton (гра закрита). Перевірено на Proton Experimental. Під Proton вивід інсталятора пишеться у файл `poe2-ukrainian/install.log` — надішліть його, якщо щось не так.
