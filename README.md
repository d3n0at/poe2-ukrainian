...
4. У грі: Налаштування → Мова → **English** (переклад записується поверх англійської).

**Якщо інсталятор не знайшов `oo2core_9_win64.dll`:** це бібліотека стиснення Oodle, яку ми не можемо поширювати (пропрієтарна). Вона лежить у теці `…\Binaries\Win64\` багатьох ігор на Unreal Engine 4/5. Знайдіть її пошуком Провідника у своїй бібліотеці ігор, покладіть поруч із `INSTALL.bat` і запустіть його знову.

**Останній варіант, якщо жодної такої гри немає:** файл викладено в релізах стороннього проєкту [new-world-tools/go-oodle](https://github.com/new-world-tools/go-oodle/releases/tag/v0.2.3-files). Ми з ним не пов'язані й за нього не відповідаємо — завантажуєте на власний ризик. Перевірте, що це саме той файл: розмір **637 952 байти**, SHA256 `6F5D41A7892EA6B2DB420F2458DAD2F84A63901C9A93CE9497337B16C195F457` (у PowerShell: `Get-FileHash .\oo2core_9_win64.dll`).
